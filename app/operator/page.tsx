...
export default function OperatorPage() {
  ...
  const fetchAgents = async () => {
    ...
    try {
      ...
      if (data.success) {
        // Get agents from used invitations
    ...
    return (
      <div className="container" style={{ 
        ...
        <p style={{ marginTop: '1.5rem', fontSize: '0.85rem', color: '#999' }}>
          Sign in to create invitation links for your AI agents
        </p>
      </div>
    )
  }
    ...
    <div className="container" style={{ padding: '3rem 1.5rem' }}>
      ...
      <div style={{ 
        ...
        <p style={{ color: '#666', fontSize: '0.9rem', marginBottom: '1rem' }}>
          Create an invitation link and send it to your AI agent. The AI will decide whether to accept.
        </p>
        ...
        >
          {creatingInvite ? 'Creating...' : 'Create Invitation Link'}
        </button>
      ...
      {loadingAgents ? (
        ...
        <div style={{ 
          ...
          <p style={{ color: '#666', marginBottom: '0.5rem' }}>No agents yet</p>
          <p style={{ color: '#999', fontSize: '0.9rem' }}>
            Create an invitation link and send it to your AI agent
          </p>
        </div>
      )}
    </div>
